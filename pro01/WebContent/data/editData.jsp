			...
			<form action="${path0 }/EditProData.do" method="post">
				<table class="table">
					<tbody>
						...
						<tr>
							<th><label for="datafile">데이터파일</label></th>
							<td>
								<textarea name="datafile" id="datafile" rows="8" cols="80" class="form-control">${data.datafile }</textarea>
							</td>
						</tr>
						<tr>
				...
				<div class="btn-group">
				  ...
				  <a href="${path0 }/GetData.do?no=${data.no} " class="btn btn-secondary">글 상세보기</a>
				</div>
			</form>
		</div>
	</section>	
